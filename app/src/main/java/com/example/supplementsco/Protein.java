...
public class Protein extends AppCompatActivity {
    ...
    private static final String TAG = "Protein";
    ...
    private DocumentReference productRef = db.collection("Product").document("c7DkKBkiifXIrFrtL60y");
    private TextView product;
    private Button proteinAddToCart;
    private Button proteinAddToWishlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product = findViewById(R.id.productData3);
        proteinAddToCart = (Button) findViewById(R.id.addToCartProtein);
        proteinAddToWishlist = (Button) findViewById(R.id.addToWishlistProtein);
        productRef.get()
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Protein.this, "cannot be read", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        proteinAddToCart.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (documentSnapshot.exists()) {
                                ...
                                Toast.makeText(Protein.this, "Item has been added to your cart", Toast.LENGTH_SHORT).show();
                            } else {
                                Map<String, Object> data = new HashMap<>();
                                data.put("quantity", quantity);
        ...
        proteinAddToWishlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                checkWishlistUser();
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (documentSnapshot.exists()) {
                                ...
                                Toast.makeText(Protein.this, "Item has been added to your wishlist", Toast.LENGTH_SHORT).show();
                            } else {
                                Map<String, Object> data = new HashMap<>();
                                data.put("quantity", quantity);
                                data.put("price", price);
