...
public class Bcaas extends AppCompatActivity {
    ...
    private DocumentReference productRef = db.collection("Product").document("PUd5WCie3IambCKuJvBK");

    private TextView product;
    private Button bcaasAddToCart;
    private Button bcaasAddToWishlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bcaas);
        product = findViewById(R.id.productData4);
        bcaasAddToCart = (Button) findViewById(R.id.addToCartBcaas);
        bcaasAddToWishlist = (Button) findViewById(R.id.addToWishlistBcaas);
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Bcaas.this, "cannot be read", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        bcaasAddToCart.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (documentSnapshot.exists()) {
                                ...
                                Toast.makeText(Bcaas.this, "Item has been added to your cart", Toast.LENGTH_SHORT).show();
                            } else {
                                Map<String, Object> data = new HashMap<>();
                                data.put("quantity", quantity);
        ...
        bcaasAddToWishlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                checkWishlistUser();
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (documentSnapshot.exists()) {
                                ...
                                Toast.makeText(Bcaas.this, "Item has been added to your wishlist", Toast.LENGTH_SHORT).show();
                            } else {
                                Map<String, Object> data = new HashMap<>();
                                data.put("quantity", quantity);
                                data.put("price", price);
